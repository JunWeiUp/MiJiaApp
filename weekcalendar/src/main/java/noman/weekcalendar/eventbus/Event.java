...
public class Event {
    ...
    public static class LastMonthEvent {
        public LastMonthEvent() {
        }
    }

    public static class NextMonthEvent {
    ...
    public static class OnMonthChange {
        ...
        public OnMonthChange(DateTime firstDayOfTheWeek, boolean isForward) {
            this.firstDayOfTheWeek = firstDayOfTheWeek;
            this.forward = isForward;
        }
