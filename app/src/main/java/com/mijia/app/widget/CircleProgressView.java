 ...
 * @PackageName:com.mijia.app.widget
 ...
 * @Copyrights 2019/6/24 handongkeji All rights reserved.
 */
...
public class CircleProgressView extends View {
     ...
     * 着色器颜色
     */
//    private int[] mShaderColors = new int[]{Color.parseColor("#8565FC"),Color.parseColor("#00ECFC"),Color.parseColor("#8565FC"),Color.parseColor("#8565FC")};
    private int[] mShaderColors = new int[]{Color.parseColor("#8565FC"),Color.parseColor("#8565FC"),Color.parseColor("#00ECFC")};
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mStrokeWidth = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 3, displayMetrics);
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (attr == R.styleable.CircleProgressView_cpvStrokeWidth) {
                mStrokeWidth = a.getDimension(attr, TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 2, displayMetrics));
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        matrix.setRotate(280, mCircleCenterX, mCircleCenterX);
        ...
        //默认着色器
        mShader = new SweepGradient(mCircleCenterX, mCircleCenterX, mShaderColors, position);
    ...
    private void drawArc(Canvas canvas) {
        ...
        DisplayMetrics displayMetrics = getDisplayMetrics();
        float kuandu = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 4, displayMetrics);
        mPaint.setStrokeWidth(kuandu);

        if (isTurn) {
            //绘制当前进度弧形
//            canvas.drawArc(rectF1, mStartAngle + mSweepAngle * getRatio(), mSweepAngle * getRatio(), false, mPaint);
            canvas.drawArc(rectF1, mSweepAngle * getRatio(), mStartAngle + mSweepAngle * getRatio(), false, mPaint);
        } else {
            //绘制当前进度弧形
