...
public class TransSuccessAuthorizationAdapter extends BaseQuickAdapter<EmpowerListBean.WaitListBean, BaseViewHolder> {
    ...
    public TransSuccessAuthorizationAdapter(int layoutResId) {
        super(layoutResId);
    }
