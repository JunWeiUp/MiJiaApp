...
public class TransRefuseAuthorizationAdapter extends BaseQuickAdapter<EmpowerListBean.WaitListBean, BaseViewHolder> {
    ...
    public TransRefuseAuthorizationAdapter(int layoutResId) {
        super(layoutResId);
    }
