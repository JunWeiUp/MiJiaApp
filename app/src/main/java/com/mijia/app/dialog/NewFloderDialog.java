...
import com.mijia.app.databinding.DialogMijiaNewfloderBinding;

public class NewFloderDialog extends Dialog {

    private DialogMijiaNewfloderBinding mBinding;

    public NewFloderDialog(@NonNull Context context) {
        super(context);
        getWindow().requestFeature(Window.FEATURE_NO_TITLE);
        View view = LayoutInflater.from(context).inflate(R.layout.dialog_mijia_newfloder, null);
        setContentView(view);
