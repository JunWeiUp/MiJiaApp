 ...
 */
public class TopWhiteBar extends FrameLayout {
    ...
    public TopWhiteBar(@NonNull final Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        LayoutInflater.from(context).inflate(R.layout.top_bar_white_layout, this);
        ...
        int centerColor = typedArray.getColor(R.styleable.TopBar_centerTextColor, Color.parseColor("#090405"));
